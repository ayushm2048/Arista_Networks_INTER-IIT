...
### Preprocess data:
python utils/preprocess_all_sims.py --input_dir "C:\dataset_tgn\logs" --dataset mywifi --workers 8

### Train Model:

#### Slow (High Accuracy):
python run_full_pipeline.py --dataset mywifi --use_combined_dataset --emb_dim 128 --tgn_epochs 30 --sugar_epochs 20 --k 5 --device cuda --max_timesteps 80000

#### Fast (Quick Test):
python run_full_pipeline.py --dataset mywifi --use_combined_dataset --emb_dim 128 --tgn_epochs 15 --sugar_epochs 10 --k 5 --device cuda --max_timesteps 50000

### Generate Embeddings:
python get_state_embedding.py --log_dir "C:\NS v14\Workspaces\Mark4\dhakshith\log" --data mywifi --save_prefix wifi_run --emb_dim 100 --device cuda --max_timesteps 80000